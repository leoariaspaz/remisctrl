...
class TransaccionesControllerTest < ActionController::TestCase
  ...
  test "should create transaccion" do
    assert_difference('Transaccion.count') do
      post :create, transaccion: { descripcion: @transaccion.descripcion, es_debito: @transaccion.es_debito, sintetico: @transaccion.sintetico }
    end
  ...
  test "should update transaccion" do
    patch :update, id: @transaccion, transaccion: { descripcion: @transaccion.descripcion, es_debito: @transaccion.es_debito, sintetico: @transaccion.sintetico }
    assert_redirected_to transaccion_path(assigns(:transaccion))
  end
